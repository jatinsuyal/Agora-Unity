...
public class DeviceChangeTest : MonoBehaviour
{
    ...
    public void Init()
    {
        rtcEngine = GetComponent<AgoraVideoScript>().rtcEngine;
        //btnCameraChange.onClick.AddListener(OnButtonClick_ChangeCamera);

        if (GetComponent<AgoraVideoScript>().instructor)
        {
            ClearDropDowns();
    ...
    public void OnButtonClick_ChangeCamera()
    {
    ...
    public void OnButtonClick_ChangeMic()
    {
